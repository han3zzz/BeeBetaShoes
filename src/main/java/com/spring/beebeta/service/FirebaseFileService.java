...
public class FirebaseFileService {
    ...
    public void init(ApplicationReadyEvent event) {
        try {
            ...
            storage = StorageOptions.newBuilder()
                    ...
                    .setProjectId("beebetashoes").build().getService();
        } catch (Exception ex) {
            ex.printStackTrace();
        }
    }
    ...
    public String saveTest(MultipartFile file) throws IOException {
        ...
        BlobId blobId = BlobId.of("beebetashoes.appspot.com", imageName);
        ...
        url.append("https://firebasestorage.googleapis.com/v0/b/beebetashoes.appspot.com/o/");
    ...
    public String deleteFile(String url) {
        try {
            String fileName = 
            url.replace("https://firebasestorage.googleapis.com/v0/b/beebetashoes.appspot.com/o/", "").replace("?alt=media", "");
            ClassPathResource serviceAccount = new ClassPathResource("firebase-service-account-key.json");
            String projectId = "beebetashoes";
            Storage storage = StorageOptions.newBuilder()
                    .setProjectId(projectId)
                    .setCredentials(GoogleCredentials.fromStream(serviceAccount.getInputStream()))
                    .build()
                    .getService();
            String bucketName = "beebetashoes.appspot.com";
